# Tagging update form
#
# This class is partially duplicated from content-tagger. Once we've added the
# same tagging interface to Whitehall and we've found out what works, we will
# probably extract this into a gem.
module Tagging
